...
<html lang="<?php echo(WebInputs::getParamenters('language', 'es')); ?>" id="#inciopartepublica">
    <head>
        ...
        <script type="text/javascript"
                src="http://maps.googleapis.com/maps/api/js?v=3&key=AIzaSyBeNRBEIWYeWRRvY8On_9pkSD1_J_zLykQ&sensor=false&libraries=geometry">
        </script>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    if (isset($_SESSION['usuario'])) {
                        ...
                        <li><a href="intranet/reservas.php" class="btn btn-outline ml-1 mt-1 coloressecundarios">Reservas</a></li>
