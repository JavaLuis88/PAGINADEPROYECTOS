...
<section id="seccionparteintranet">
    ...
    <article>
        ...
        <article id="contenedor" class="container-fluid">

            <form method="POST" action="consulta_custom.php" accept-charset="utf-8">

                <article id="consulta" class="row justify-content-center pt-5">
                    <article class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3 ">
                        <header>
                            <h3 class="subcabeceracontroles">
                    ...
                    <article class="col-5 col-sm-5 col-md-4 col-lg-4 col-xl-4">

                        <header>
                            <h3 class="subcabeceracontroles">

                                CL&Aacute;USULAS WHERE
                            </h3>
