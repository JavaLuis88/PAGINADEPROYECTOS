...
$_PARAMETERS['title'] = "C.I.F.P Santa Catalina-Modificación de tipos";
$_PARAMETERS['charset'] = "utf-8";
$_PARAMETERS['description'] = "Sección de modificación de tipos en el inventario";
$_PARAMETERS['keywords'] = "Inventario, Modificación, Tipos";
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <div class="container">
                        <form action="modificaciones.php" method="post" autocomplete="off" class="form-horizontal">
