...
$_PARAMETERS['title'] = "C.I.F.P Santa Catalina-Modificación de proveedores";
$_PARAMETERS['charset'] = "utf-8";
$_PARAMETERS['description'] = "Sección de modificación de proveedores en el inventario";
$_PARAMETERS['keywords'] = "Inventario, Modificación, Proveedores";
...
<section id="seccionparteintranet">
    ...
    <article>
        <header>
            <h2 class="text-center"><strong class="border">Modificar Proveedor</strong></h2>
        ...
        <form action="validad_modificacionesprove.php" method="post" autocomplete="off" class="form-horizontal">
