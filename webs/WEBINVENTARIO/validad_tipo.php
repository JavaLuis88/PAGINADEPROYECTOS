...
$_PARAMETERS['description'] = "Resumen del alta del tipo";
        ...
        <div class="container theme-showcase" role="main">
            <div class="jumbotron">
                ...
                <div class="row justify-content-center">
                    ...
                    <a href="alta_tipo.php" class="btn btn-danger">No, volver a atrás</a>
                        <a href="enviar_tipo.php?Nombre=&Abrev=" class="btn btn-info">
