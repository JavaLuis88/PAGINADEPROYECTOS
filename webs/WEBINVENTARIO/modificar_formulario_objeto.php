...
$_PARAMETERS['description'] = "Sección de modificación de objetos en el inventario";
$_PARAMETERS['keywords'] = "Inventario, Modificación, Objetos";
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <form action="validad_modificaciones.php" method="post" autocomplete="off" class="form-horizontal">
