...
$_PARAMETERS['title'] = "C.I.F.P Santa Catalina-Modificación de objetos";
$_PARAMETERS['charset'] = "utf-8";
$_PARAMETERS['description'] = "Exito en la modificación del objeto";
$_PARAMETERS['keywords'] = "Modificación, Objetos, Exito";
...
<section id="seccionparteintranet">
    ...
    <article>
        <header>
            <h2 class="text-center"><strong>Modificar Objeto</strong></h2>
        ...
        <div class="container theme-showcase" role="main">
            <div class="jumbotron">
                ...
                <h2 class="text-center"> Se ha modificado correctamente el  objeto </h2>
                <p class="text-center">
                    <a href="modificar_objeto.php" class="btn btn-info">Volver a atrás</a>
