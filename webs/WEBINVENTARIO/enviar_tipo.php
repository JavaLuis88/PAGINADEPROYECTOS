...
$_PARAMETERS['keywords'] = "Inventario, Altas, Tipos, Exito";
...
<section id="seccionparteintranet">
    ...
    <article>
        <header>
            <h2 class="text-center"><strong>Alta de tipos</strong></h2>
        ...
        <div class="container theme-showcase" role="main">
            <div class="jumbotron">
                ...
                <h2 class="text-center"> Se ha insertado correctamente el nuevo tipo </h2>
            <p class="text-center">
