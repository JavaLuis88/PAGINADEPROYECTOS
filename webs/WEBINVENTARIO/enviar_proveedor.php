...
$_PARAMETERS['keywords'] = "Inventario, Altas, Proveedores, Exito";
    ...
    <article>
        ...
        <div class="container theme-showcase" role="main">
            <div class="jumbotron">
                ...
                <h2 class="text-center"> Se ha insertado correctamente el Proveedor </h2>
            <p class="text-center">
                <a href="alta_provedor.php" class="btn btn-info">Volver a atrás</a>
