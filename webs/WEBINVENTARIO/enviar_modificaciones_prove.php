...
$_PARAMETERS['description'] = "Modificación de proveedores en el inventario";
    ...
    <article>
        ...
        <div class="container theme-showcase" role="main">
            <div class="jumbotron">
                ...
                <h2 class="text-center"> Se ha modificado correctamente el Proveedor </h2>
            <p class="text-center">
                <a href="modificar_proveedor.php" class="btn btn-info">Volver a atrás</a>
