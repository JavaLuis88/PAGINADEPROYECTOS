...
<section id="seccionparteintranet">
    ...
    <article>
        <header>
            ...
            <h3 class="text-center">Resumen del Proveedor</h3>
        </header>
        <!-- 
         <div class="container">
            ...
            <div class="jumbotron">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <a href="modificar_proveedor.php" class="btn btn-danger">No, volver a atrás</a>
                        <a href="enviar_modificaciones_prove.php?Nombre=&Direccion=&Tele=&CIF=&Email=&Descripcion=" class="btn btn-info">
