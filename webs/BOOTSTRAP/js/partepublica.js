function iniciar() {
    ...
    if (location.pathname.toUpperCase() == "/BOOTSTRAP/REGISTRO.PHP") {
    ...
    } else if (location.pathname.toUpperCase() == "/BOOTSTRAP/IDENTIFICACION.PHP") {
    ...
    } else if (location.pathname.toUpperCase() == "/BOOTSTRAP/RECUPERARCONTRASENA.PHP") {
    ...
    } else if (location.pathname.toUpperCase() == "/BOOTSTRAP/JUMBOTRON.PHP") {
...
function validarformularioregistro() {
    ...
    if (document.getElementById("pwd2").validity.valid) {
        document.getElementById("pwd2").className = document.getElementById("pwd2").className + " validado";
