...
$_PARAMETERS['keywords'] = "Registro, usuario, creacion de cuentas, contraseña";
...
<section class="espaciadoinferior1per">
    ...
    <form action="jumbotron.php" method="post" name="formularioregistro" id="formularioregistro" class="form-horizontal">
