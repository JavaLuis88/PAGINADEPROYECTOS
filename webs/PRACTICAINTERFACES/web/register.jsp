...
<jsp:include page="templates/publicheader.jsp">
    <jsp:param name="descripcion" value="Página de registro"/>
    <jsp:param name="plabrasclave" value="Registro, clientes, empresas"/>
    <jsp:param name="autor" value="Super Eñe"/>
    <jsp:param name="robots" value="NOARCHIVE, NOODP, NOYDIR"/>
    <jsp:param name="titulo" value="CRUMP-Registro de usuario"/>
