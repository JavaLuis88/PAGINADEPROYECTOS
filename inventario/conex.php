...
class Conexion {
    ...
    function Conexion() {
        $this->host = "localhost"; //
        $this->usuario = "admininvsc"; //usuario que tengas definido
        $this->contrasena = "admin2013"; //contraseña que tengas definidad
        $this->baseDatos = "inventariosc"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
    }
