                        ...
                        <div id="consulta">
                            <form method="POST" action="consulta_custom.php" accept-charset="utf-8">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            $sql = mysqli_query($objeConexion,"SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='objetos'");
                                ...
                                <input id="hidd" type="hidden" name="hidden" value="">
                                    ...
                                    <?php //<input id="nobaja" type='checkbox' name='nobaja' value='nobaja' /> No está dado de baja	 ?></form>
